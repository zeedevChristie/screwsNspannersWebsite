...
const ContactUs = () => {
  const backgroundImage =
    window.innerWidth > 768 ? contactBackground : contactBackground2;
        ...
        <div className="flex flex-col items-center w-full md:w-1/3">
          ...
          <div className="flex flex-col text-center space-y-6">
            <div className="flex items-center justify-center space-x-2">
              ...
              <p className="text-sm md:text-lg lg:text-xl font-serif">
                Plot 29 Shittu Animashaun Street, Gbagada, Lagos, Nigeria
              </p>
            </div>
            <div className="space-y-2">
              <p className="text-sm md:text-lg lg:text-xl font-semibold">📞 0704 700 1592</p>
