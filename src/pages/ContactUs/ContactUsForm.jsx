...
const WhatsAppForm = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center  p-4">
      <div className=" text-black p-5 rounded-lg shadow-md w-full max-w-md">
        <h2 className="text-xl font-bold mb-4 text-white text-center">Send a WhatsApp Message</h2>
